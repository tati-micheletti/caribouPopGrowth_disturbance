...
caribouFolder <- "~/projects/caribouPopGrowth_disturbance/outputs/run1"
disturbancesFolder <- "~/projects/anthroDisturbance_Generator/outputs/run1/"
googleFolder <- "1C68BZU6eMF1FaXCOsyVnO8BVBqEsbElB"
